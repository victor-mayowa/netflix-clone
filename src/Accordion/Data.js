export const Data = [
    ...
    },
    {
        ...
        answer1:"Watch anywhere, anytime. Sign in with your Netflix account to watch instantly on the web at netflix.com from your personal computer or on any internet-connected device that offers the Netflix app, including smart TVs, smartphones, tablets, streaming media plyers and game consoles.",
    ...
    },
    {
        ...
        answer1:"Netflix is flexible. There are no pesky contracts and no commitments. You cna easily cancel your account online in two clicks. There ae no cancellation fees - start or stop your account anytime."
    },
    {
        question:"What can watch on Netflix?",
        answer1:"Netflix has an extensive library of feature films, documentaries, TV showa, anime, award-winning Netflix originals, and more. Watch as much as you want, anytime you want."
    },
    {
        ...
        answer2:"Kids profiles comw with PIN-protected parental controls that let you restrict the maturity rating of content kids can watch ad block soecific titles you don't want kids to see."
    }
]